    ...
    if request.method == 'POST':
        ...
        if login_info.is_valid():
            ...
            if check:
                ...
                request.session['user'] = check['name']
...
def check_session(request):
    if request.session['department'] == "administration":
        return reverse('administrator:admin_home')
    ...
    elif request.session['department']=="hr":
...
class list_employee(ListView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if temp == True :
            return super(list_employee, self).get(request, *args, **kwargs)
        else:
...
class add_employee(CreateView):
    ...
    def get(self, request, *args, **kwargs):
        temp = check_session_exist(self.request)
        if temp == True :
            return super(add_employee, self).get(request, *args, **kwargs)
        else:
            return HttpResponseRedirect(temp)
...
class deail_employee(DetailView):
    ...
    def get(self, request, *args, **kwargs):
        temp = check_session_exist(self.request)
        if temp == True :
            return super(deail_employee, self).get(request, *args, **kwargs)
        else:
            return HttpResponseRedirect(temp)
...
class update_employee(UpdateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if temp == True :
            # print("Ollo#@#$%^&*(&^#@#$^&*(*&^%$#$%^&*(*&^%$&")
            return super(update_employee, self).get(request, *args, **kwargs)
        else:
            return HttpResponseRedirect(temp)
...
class search_employee(ListView):
    ...
    def get(self, request, *args, **kwargs):
        temp = check_session_exist(self.request)
        if temp == True :
            return super(search_employee, self).get(request, *args, **kwargs)
        else:
            return HttpResponseRedirect(temp)
